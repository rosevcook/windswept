...
public class FloweringAcaciaTreeGrower extends AbstractTreeGrower {
    @Override
    protected ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(RandomSource rand, boolean bees) {
        return bees ? WindsweptConfiguredFeatures.FLOWERING_ACACIA_BEES : WindsweptConfiguredFeatures.FLOWERING_ACACIA;
    }
