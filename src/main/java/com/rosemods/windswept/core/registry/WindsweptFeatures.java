...
public final class WindsweptFeatures {
    ...
    public static class Placements {
        ...
        public static final RegistryObject<PlacedFeature> FALLEN_LOG = register("fallen_log", Features.FALLEN_LOG, PlacementUtils.countExtra(0, .1f, 2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome(), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        ...
        public static final RegistryObject<PlacedFeature> FERNS = register("ferns", Features.FERNS, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
