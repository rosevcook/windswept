...
public class WindsweptBlocks {
	...
	public static final RegistryObject<Block> HOLLY_CABINET = HELPER.createCompatFuelBlock(WindsweptConstants.FARMERS_DELIGHT, "holly_cabinet", ModList.get().isLoaded(WindsweptConstants.FARMERS_DELIGHT) ? WindsweptFDCompat.CABINET_SUPPLIER : () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE)), 300, CreativeModeTab.TAB_DECORATIONS);
	...
	public static final RegistryObject<Block> CHESTNUT_SAPLING = HELPER.createBlock("chestnut_sapling", () -> new BlueprintSaplingBlock(new ChesnutTreeGrower(), PropertyUtil.SAPLING), CreativeModeTab.TAB_DECORATIONS);
	...
	public static final RegistryObject<Block> PACKED_ICE_BRICK_WALL = HELPER.createBlock("packed_ice_brick_wall", () -> new WallBlock(Properties.ICE_BRICKS), CreativeModeTab.TAB_BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> BLUE_ICE_BRICK_WALL = HELPER.createBlock("blue_ice_brick_wall", () -> new WallBlock(Properties.ICE_BRICKS), CreativeModeTab.TAB_BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> GOLDEN_DOOR = HELPER.createInjectedBlock("golden_door", Items.IRON_DOOR, () -> new DoorBlock(Properties.GOLDEN_DOOR), CreativeModeTab.TAB_REDSTONE);
	public static final RegistryObject<Block> GOLDEN_TRAPDOOR = HELPER.createInjectedBlock("golden_trapdoor", Items.IRON_TRAPDOOR, () -> new TrapDoorBlock(Properties.GOLDEN_TRAPDOOR), CreativeModeTab.TAB_REDSTONE);

	// Sprouts //
	
	public static final RegistryObject<Block> SNOWY_SPROUTS = HELPER.createInjectedBlock("snowy_sprouts", Items.DEAD_BUSH, () -> new SnowySproutsBlock(Properties.SNOWY_SPROUTS), CreativeModeTab.TAB_DECORATIONS);
	
	// Flowers //
	
	public static final RegistryObject<Block> RED_ROSE = HELPER.createBlock("red_rose", () -> new BlueprintFlowerBlock(() -> MobEffects.WITHER, 5, PropertyUtil.FLOWER), CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Block> PINK_ROSE = HELPER.createBlock("pink_rose", () -> new BlueprintFlowerBlock(() -> MobEffects.WITHER, 5, PropertyUtil.FLOWER), CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Block> BLUE_ROSE = HELPER.createBlock("blue_rose", () -> new BlueprintFlowerBlock(() -> MobEffects.WITHER, 5, PropertyUtil.FLOWER), CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Block> WHITE_ROSE = HELPER.createBlock("white_rose", () -> new BlueprintFlowerBlock(() -> MobEffects.WITHER, 5, PropertyUtil.FLOWER), CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Block> YELLOW_ROSE = HELPER.createBlock("yellow_rose", () -> new BlueprintFlowerBlock(() -> MobEffects.WITHER, 5, PropertyUtil.FLOWER), CreativeModeTab.TAB_DECORATIONS);
