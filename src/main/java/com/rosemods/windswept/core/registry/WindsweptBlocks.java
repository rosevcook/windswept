...
public class WindsweptBlocks {
    ...
    // Tundra Moss Blocks //
    public static final RegistryObject<Block> TUNDRA_MOSS_CARPET = HELPER.createInjectedBlock("tundra_moss_carpet", Items.MOSS_BLOCK, () -> new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.MOSS_CARPET)), CreativeModeTab.TAB_DECORATIONS);
    public static final RegistryObject<Block> TUNDRA_MOSS_BLOCK = HELPER.createInjectedBlock("tundra_moss_block", Items.MOSS_BLOCK, () -> new MossBlock(BlockBehaviour.Properties.copy(Blocks.MOSS_BLOCK)), CreativeModeTab.TAB_DECORATIONS);

    public static final RegistryObject<Block> TUNDRA_MOSSY_COBBLESTONE = HELPER.createInjectedBlock("tundra_mossy_cobblestone", Items.MOSSY_COBBLESTONE, () -> new Block(BlockBehaviour.Properties.copy(Blocks.MOSSY_COBBLESTONE)), CreativeModeTab.TAB_BUILDING_BLOCKS);
    public static final RegistryObject<Block> TUNDRA_MOSSY_COBBLESTONE_STAIRS = HELPER.createInjectedBlock("tundra_mossy_cobblestone_stairs", Items.MOSSY_COBBLESTONE_STAIRS, () -> new StairBlock(TUNDRA_MOSSY_COBBLESTONE.get()::defaultBlockState, BlockBehaviour.Properties.copy(Blocks.MOSSY_COBBLESTONE)), CreativeModeTab.TAB_BUILDING_BLOCKS);
    public static final RegistryObject<Block> TUNDRA_MOSSY_COBBLESTONE_SLAB = HELPER.createInjectedBlock("tundra_mossy_cobblestone_slab", Items.MOSSY_COBBLESTONE_SLAB, () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.MOSSY_COBBLESTONE)), CreativeModeTab.TAB_BUILDING_BLOCKS);
    public static final RegistryObject<Block> TUNDRA_MOSSY_COBBLESTONE_WALL = HELPER.createInjectedBlock("tundra_mossy_cobblestone_wall", Items.MOSSY_COBBLESTONE_WALL, () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.MOSSY_COBBLESTONE)), CreativeModeTab.TAB_DECORATIONS);
    public static final RegistryObject<Block> TUNDRA_MOSSY_COBBLESTONE_VERTICAL_SLAB = HELPER.createCompatBlock(WindsweptConstants.QUARK, "tundra_mossy_cobblestone_vertical_slab", () -> new VerticalSlabBlock(BlockBehaviour.Properties.copy(Blocks.MOSSY_COBBLESTONE)), CreativeModeTab.TAB_BUILDING_BLOCKS);

    public static final RegistryObject<Block> TUNDRA_MOSSY_STONE_BRICKS = HELPER.createInjectedBlock("tundra_mossy_stone_bricks", Items.MOSSY_STONE_BRICKS, () -> new Block(BlockBehaviour.Properties.copy(Blocks.MOSSY_STONE_BRICKS)), CreativeModeTab.TAB_BUILDING_BLOCKS);
    public static final RegistryObject<Block> TUNDRA_MOSSY_STONE_BRICK_STAIRS = HELPER.createInjectedBlock("tundra_mossy_stone_brick_stairs", Items.MOSSY_STONE_BRICK_STAIRS, () -> new StairBlock(TUNDRA_MOSSY_STONE_BRICKS.get()::defaultBlockState, BlockBehaviour.Properties.copy(Blocks.MOSSY_STONE_BRICKS)), CreativeModeTab.TAB_BUILDING_BLOCKS);
    public static final RegistryObject<Block> TUNDRA_MOSSY_STONE_BRICK_SLAB = HELPER.createInjectedBlock("tundra_mossy_stone_brick_slab", Items.MOSSY_STONE_BRICK_SLAB, () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.MOSSY_STONE_BRICKS)), CreativeModeTab.TAB_BUILDING_BLOCKS);
    public static final RegistryObject<Block> TUNDRA_MOSSY_STONE_BRICK_WALL = HELPER.createInjectedBlock("tundra_mossy_stone_brick_wall", Items.MOSSY_STONE_BRICK_WALL, () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.MOSSY_STONE_BRICKS)), CreativeModeTab.TAB_DECORATIONS);
    public static final RegistryObject<Block> TUNDRA_MOSSY_STONE_BRICK_VERTICAL_SLAB = HELPER.createCompatBlock(WindsweptConstants.QUARK, "tundra_mossy_stone_brick_vertical_slab", () -> new VerticalSlabBlock(BlockBehaviour.Properties.copy(Blocks.MOSSY_STONE_BRICKS)), CreativeModeTab.TAB_BUILDING_BLOCKS);
