...
public final class WindsweptBiomeModifiers {
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        // features
        addFeature(context, "bluebells", WindsweptBiomeTags.HAS_BLUEBELLS, GenerationStep.Decoration.VEGETAL_DECORATION, BLUEBELLS);
        addFeature(context, "snowy_sprouts", Tags.Biomes.IS_SNOWY, GenerationStep.Decoration.VEGETAL_DECORATION, SNOWY_SPROUTS);
        ...
        addFeature(context, "rare_snowy_holly_trees", WindsweptBiomeTags.HAS_RARE_SNOWY_HOLLY_TREES, GenerationStep.Decoration.VEGETAL_DECORATION, RARE_HOLLY_TREES_ON_SNOW);
        addFeature(context, "icicles", Tags.Biomes.IS_SNOWY, GenerationStep.Decoration.VEGETAL_DECORATION, ICICLES, FLOOR_ICICLES);
        addFeature(context, "shale", Tags.Biomes.IS_SNOWY, GenerationStep.Decoration.UNDERGROUND_ORES, SHALE);
        addFeature(context, "red_roses", WindsweptBiomeTags.HAS_RED_ROSE, GenerationStep.Decoration.VEGETAL_DECORATION, RED_ROSE);
        addFeature(context, "blue_roses", WindsweptBiomeTags.HAS_BLUE_ROSE, GenerationStep.Decoration.VEGETAL_DECORATION, BLUE_ROSE);
        addFeature(context, "white_roses", WindsweptBiomeTags.HAS_WHITE_ROSE, GenerationStep.Decoration.VEGETAL_DECORATION, WHITE_ROSE);
        ...
        // removed features
        removeFeature(context, "grove_spruce_trees", Biomes.GROVE, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.TREES_GROVE);
        removeFeature(context, "taiga_default_flowers", BiomeTags.IS_TAIGA, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.FLOWER_DEFAULT);
