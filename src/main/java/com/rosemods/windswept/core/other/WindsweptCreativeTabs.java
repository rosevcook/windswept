    ...
    public static void setupTabEditors() {
        CreativeModeTabContentsPopulator.mod(Windswept.MOD_ID)
                ...
                .addItemsAfter(Ingredient.of(Blocks.POLISHED_ANDESITE_SLAB), SHALE, SHALE_STAIRS, SHALE_SLAB, SHALE_WALL, POLISHED_SHALE, POLISHED_SHALE_STAIRS, POLISHED_SHALE_SLAB, POLISHED_SHALE_WALL,
                        POLISHED_SHALE_BRICKS, CHISELED_POLISHED_SHALE_BRICKS, POLISHED_SHALE_BRICK_STAIRS, POLISHED_SHALE_BRICK_SLAB, POLISHED_SHALE_BRICK_WALL, POLISHED_SHALE_PRESSURE_PLATE, POLISHED_SHALE_BUTTON)
                .addItemsAfter(Ingredient.of(Blocks.MUD_BRICK_WALL), PINECONE_BLOCK, PINECONE_SHINGLES, PINECONE_SHINGLE_STAIRS, PINECONE_SHINGLE_SLAB, PINECONE_SHINGLE_WALL,
                ...
                .addItemsAfter(Ingredient.of(Blocks.DEEPSLATE_TILE_WALL), POLISHED_DEEPSLATE_PRESSURE_PLATE, POLISHED_DEEPSLATE_BUTTON)
                ...
                .addItemsAfter(Ingredient.of(Blocks.LILY_OF_THE_VALLEY), FOXGLOVE, SNOWDROP, NIGHTSHADE, BLUEBELLS,
                ...
                .addItemsAfter(Ingredient.of(Items.TURTLE_HELMET), ANTLER_HELMET, SNOW_BOOTS)
                ...
                .tab(FOOD_AND_DRINKS)
                .addItemsAfter(Ingredient.of(Items.HONEY_BOTTLE), PINECONE_JAM_BOTTLE, WILD_BERRY_JUICE, LAVENDER_TEA, GINGER_TEA)
                .addItemsBefore(Ingredient.of(Items.CAKE), CANDY_CANE, LAVENDER_SCONES)
                .addItemsAfter(Ingredient.of(Items.COOKIE), GINGERBREAD_COOKIE, WILD_BERRY_COOKIE)
                .addItemsAfter(Ingredient.of(Items.SWEET_BERRIES), SWEET_BERRY_BOWL, WILD_BERRIES, WILD_BERRY_BOWL, WILD_BERRY_POPSICLE)
                ...
                .addItemsAfter(Ingredient.of(Items.POISONOUS_POTATO), GINGER_ROOT, GINGER_SNOW_CONE)
