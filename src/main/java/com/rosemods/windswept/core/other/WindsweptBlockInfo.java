...
public final class WindsweptBlockInfo {
    ...
    public static void registerCompostables() {
        ...
        DataUtil.registerCompostable(WindsweptItems.ROASTED_CHESTNUTS.get(), .3f);

        DataUtil.registerCompostable(WindsweptBlocks.CHESTNUT_CRATE.get(), 1f);
        DataUtil.registerCompostable(WindsweptBlocks.ROASTED_CHESTNUT_CRATE.get(), 1f);
        DataUtil.registerCompostable(WindsweptBlocks.HOLLY_BERRY_BASKET.get(), 1f);
        DataUtil.registerCompostable(WindsweptBlocks.WILD_BERRY_BASKET.get(), 1f);
        DataUtil.registerCompostable(WindsweptBlocks.RED_MUSHROOM_BASKET.get(), 1f);
        DataUtil.registerCompostable(WindsweptBlocks.BROWN_MUSHROOM_BASKET.get(), 1f);
        DataUtil.registerCompostable(WindsweptBlocks.GLOW_SHROOM_BASKET.get(), 1f);
        ...
        DataUtil.registerCompostable(WindsweptBlocks.RED_ROSE_BUSH.get(), .65f);
        DataUtil.registerCompostable(WindsweptBlocks.PINK_ROSE_BUSH.get(), .65f);
        DataUtil.registerCompostable(WindsweptBlocks.BLUE_ROSE_BUSH.get(), .65f);
        DataUtil.registerCompostable(WindsweptBlocks.WHITE_ROSE_BUSH.get(), .65f);
        DataUtil.registerCompostable(WindsweptBlocks.YELLOW_ROSE_BUSH.get(), .65f);
        DataUtil.registerCompostable(WindsweptBlocks.WITHER_ROSE_BUSH.get(), .65f);
        ...
        DataUtil.registerCompostable(WindsweptItems.WILD_BERRY_COOKIE.get(), .85f);
        DataUtil.registerCompostable(WindsweptItems.MUTTON_PIE.get(), 1f);
    }
    ...
    public static void registerFlammables() {
        ...
        DataUtil.registerFlammable(WindsweptBlocks.HOLLY_BERRY_BASKET.get(), 5, 20);
        ...
        DataUtil.registerFlammable(WindsweptBlocks.RED_MUSHROOM_BASKET.get(), 5, 20);
        DataUtil.registerFlammable(WindsweptBlocks.BROWN_MUSHROOM_BASKET.get(), 5, 20);
        DataUtil.registerFlammable(WindsweptBlocks.GLOW_SHROOM_BASKET.get(), 5, 20);
        ...
        DataUtil.registerFlammable(WindsweptBlocks.RED_ROSE_BUSH.get(), 60, 100);
        DataUtil.registerFlammable(WindsweptBlocks.PINK_ROSE_BUSH.get(), 60, 100);
        DataUtil.registerFlammable(WindsweptBlocks.BLUE_ROSE_BUSH.get(), 60, 100);
