...
public final class WindsweptDataProcessors {
	...
	public static final TrackedData<Boolean> JUMBO_RABBIT = TrackedData.Builder.create(DataProcessors.BOOLEAN, () -> false).enableSaving().build();
	...
	public static void registerData() {
		...
		register("jumbo_rabbit", JUMBO_RABBIT);
	}
