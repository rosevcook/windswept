...
public final class WindsweptTiers {
    ...
    public static final BlueprintArmorMaterial ANTLER_HELMET = new BlueprintArmorMaterial(Windswept.location("antler_helmet"), 8, new int[]{0, 0, 0, 1}, 17, () -> SoundEvents.ARMOR_EQUIP_GENERIC, 0f, 0f, () -> Ingredient.of(Items.BONE));
}
