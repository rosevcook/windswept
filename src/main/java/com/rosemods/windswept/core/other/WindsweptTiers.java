...
public final class WindsweptTiers {
    ...
    public static final BlueprintArmorMaterial LAVENDER_CROWN = new BlueprintArmorMaterial(Windswept.location("lavender_crown"), 3, new int[]{0, 0, 0, 0}, 10, () -> SoundEvents.AZALEA_BREAK, 0f, 0f, () -> Ingredient.of(WindsweptBlocks.LAVENDER.get()));
}
