...
public final class WindsweptTiers {
    ...
    public static final BlueprintArmorMaterial FEATHER_CLOAK = new BlueprintArmorMaterial(Windswept.location("feather_cloak"), 8, new int[]{0, 0, 1, 0}, 17, () -> SoundEvents.ARMOR_EQUIP_GENERIC, 0f, 0f, () -> Ingredient.of(WindsweptItems.ELDER_FEATHER.get()));
}
