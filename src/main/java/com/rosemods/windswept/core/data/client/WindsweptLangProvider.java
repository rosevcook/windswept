...
public class WindsweptLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.translateBlock(WILD_GINGER);
        ...
        this.translateBlock(POTTED_WILD_GINGER);
        ...
        this.translateBlock(LUNALITE);
        this.translateBlock(LUNALITE_STAIRS);
        this.translateBlock(LUNALITE_SLAB);
        this.translateBlock(LUNALITE_WALL);
        this.translateBlock(LUNALITE_VERTICAL_SLAB);
        this.translateBlock(CUT_LUNALITE);
        this.translateBlock(CUT_LUNALITE_STAIRS);
        this.translateBlock(CUT_LUNALITE_SLAB);
        this.translateBlock(CUT_LUNALITE_WALL);
        this.translateBlock(CUT_LUNALITE_VERTICAL_SLAB);
        this.translateBlock(CUT_LUNALITE_BRICKS);
        this.translateBlock(CHISELED_CUT_LUNALITE_BRICKS);
        this.translateBlock(CUT_LUNALITE_BRICK_STAIRS);
        this.translateBlock(CUT_LUNALITE_BRICK_SLAB);
        this.translateBlock(CUT_LUNALITE_BRICK_WALL);
        this.translateBlock(CUT_LUNALITE_BRICK_VERTICAL_SLAB);
        this.translateBlock(SMOOTH_LUNALITE);
        this.translateBlock(SMOOTH_LUNALITE_SLAB);
        this.translateBlock(SMOOTH_LUNALITE_STAIRS);
        this.translateBlock(SMOOTH_LUNALITE_VERTICAL_SLAB);
