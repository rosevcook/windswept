...
public class WindsweptBiomeTagProvider extends BiomeTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(WindsweptBiomeTags.IS_CHESTNUT_FOREST).add(WindsweptBiomes.CHESTNUT_FOREST.getKey(), WindsweptBiomes.SNOWY_CHESTNUT_FOREST.getKey());
        ...
        this.tag(BiomeTags.IS_OVERWORLD).add(WindsweptBiomes.CHESTNUT_FOREST.getKey(), WindsweptBiomes.SNOWY_CHESTNUT_FOREST.getKey());
