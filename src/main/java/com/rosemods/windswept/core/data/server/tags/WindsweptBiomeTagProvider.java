...
public class WindsweptBiomeTagProvider extends BiomeTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(IS_LAVENDER).add(LAVENDER_MEADOW);
        ...
        this.tag(HAS_STRAWBERRY_BUSH).add(LAVENDER_MEADOW);

        this.tag(BlueprintBiomeTags.IS_GRASSLAND).add(LAVENDER_MEADOW);
        this.tag(BiomeTags.IS_MOUNTAIN).add(SNOWY_PINE_BARRENS, LAVENDER_MEADOW);
        this.tag(BiomeTags.IS_OVERWORLD).add(CHESTNUT_FOREST, SNOWY_CHESTNUT_FOREST, PINE_BARRENS, SNOWY_PINE_BARRENS, TUNDRA);
