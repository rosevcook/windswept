...
public class WindsweptBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(BlockTags.SLABS).add(BLUE_ICE_BRICK_SLAB.get(), SNOW_BRICK_SLAB.get(), PACKED_ICE_BRICK_SLAB.get(), PACKED_ICE_SLAB.get(), BLUE_ICE_BRICK_SLAB.get(), SNOW_SLAB.get(), DRY_MOSSY_COBBLESTONE_SLAB.get(), DRY_MOSSY_STONE_BRICK_SLAB.get(), SHALE_SLAB.get(), POLISHED_SHALE_SLAB.get(), POLISHED_SHALE_BRICK_SLAB.get(), PINECONE_SHINGLE_SLAB.get(), DOLOMITE_SLAB.get(), CUT_DOLOMITE_SLAB.get(), CUT_DOLOMITE_BRICK_SLAB.get(), SMOOTH_DOLOMITE_SLAB.get(), GINGERBREAD_BRICK_SLAB.get(), GLAZED_GINGERBREAD_BRICK_SLAB.get(), DRY_MOSSY_COBBLESTONE_BRICK_SLAB.get(), DRY_MOSSY_COBBLESTONE_TILE_SLAB.get());
        this.tag(BlockTags.STAIRS).add(BLUE_ICE_BRICK_STAIRS.get(), SNOW_BRICK_STAIRS.get(), PACKED_ICE_BRICK_STAIRS.get(), PACKED_ICE_STAIRS.get(), BLUE_ICE_STAIRS.get(), SNOW_STAIRS.get(), DRY_MOSSY_COBBLESTONE_STAIRS.get(), DRY_MOSSY_STONE_BRICK_STAIRS.get(), SHALE_STAIRS.get(), POLISHED_SHALE_STAIRS.get(), POLISHED_SHALE_BRICK_STAIRS.get(), PINECONE_SHINGLE_STAIRS.get(), DOLOMITE_STAIRS.get(), CUT_DOLOMITE_STAIRS.get(), CUT_DOLOMITE_BRICK_STAIRS.get(), SMOOTH_DOLOMITE_STAIRS.get(), GINGERBREAD_BRICK_STAIRS.get(), GLAZED_GINGERBREAD_BRICK_STAIRS.get(), DRY_MOSSY_COBBLESTONE_BRICK_STAIRS.get(), DRY_MOSSY_COBBLESTONE_TILE_STAIRS.get());
