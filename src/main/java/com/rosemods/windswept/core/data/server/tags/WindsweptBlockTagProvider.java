...
public class WindsweptBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(BlockTags.MINEABLE_WITH_HOE).add(HOLLY_LEAVES.get(), CHESTNUT_LEAVES.get(), PINE_LEAVES.get(), HOLLY_LEAF_CARPET.get(), CHESTNUT_LEAF_CARPET.get(), PINE_LEAF_CARPET.get(), FROZEN_FLESH_BLOCK.get(), DRY_MOSS_CARPET.get(), DRY_MOSS_BLOCK.get(), FEATHER_ORNAMENT.get(), LAVENDER_THATCH.get(), LAVENDER_THATCH_STAIRS.get(), LAVENDER_THATCH_SLAB.get(), LAVENDER_THATCH_VERTICAL_SLAB.get(), LAVENDER_BUNDLE.get());
