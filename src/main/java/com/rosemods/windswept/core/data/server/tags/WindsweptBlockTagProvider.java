...
public class WindsweptBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(BlockTags.SMALL_FLOWERS).add(RED_ROSE.get(), PINK_ROSE.get(), BLUE_ROSE.get(), WHITE_ROSE.get(), YELLOW_ROSE.get(), FOXGLOVE.get(), BLUEBELLS.get(), NIGHTSHADE.get(), SNOWDROP.get(), MOSS_CAMPION.get(), GINGER_FLOWER.get());
        this.tag(BlockTags.FLOWER_POTS).add(POTTED_RED_ROSE.get(), POTTED_PINK_ROSE.get(), POTTED_BLUE_ROSE.get(), POTTED_WHITE_ROSE.get(), POTTED_YELLOW_ROSE.get(), POTTED_FOXGLOVE.get(), POTTED_BLUEBELLS.get(), POTTED_NIGHTSHADE.get(), POTTED_HOLLY_SAPLING.get(), POTTED_CHESTNUT_SAPLING.get(), POTTED_PINE_SAPLING.get(), POTTED_SNOWY_SPROUTS.get(), POTTED_SNOWDROP.get(), POTTED_GELISOL_SPROUTS.get(), POTTED_DRY_MOSS_SPROUTS.get(), POTTED_MOSS_CAMPION.get(), POTTED_GINGER_FLOWER.get());
