...
public class WindsweptBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(BlockTags.TALL_FLOWERS).add(RED_ROSE_BUSH.get(), BLUE_ROSE_BUSH.get(), WHITE_ROSE_BUSH.get(), YELLOW_ROSE_BUSH.get(), WITHER_ROSE_BUSH.get(), LUPINE.get());
        this.tag(BlockTags.REPLACEABLE_PLANTS).add(RED_ROSE_BUSH.get(), BLUE_ROSE_BUSH.get(), WHITE_ROSE_BUSH.get(), YELLOW_ROSE_BUSH.get(), WITHER_ROSE_BUSH.get(), SNOWY_SPROUTS.get(), GELISOL_SPROUTS.get(), DRY_MOSSY_SPROUTS.get(), MOSSY_SPROUTS.get());
        this.tag(BlockTags.SMALL_FLOWERS).add(RED_ROSE.get(), BLUE_ROSE.get(), WHITE_ROSE.get(), YELLOW_ROSE.get(), FOXGLOVE.get(), BLUEBELLS.get(), NIGHTSHADE.get(), SNOWDROP.get(), MOSS_CAMPION.get(), GINGER_FLOWER.get());
        this.tag(BlockTags.FLOWER_POTS).add(POTTED_RED_ROSE.get(), POTTED_BLUE_ROSE.get(), POTTED_WHITE_ROSE.get(), POTTED_YELLOW_ROSE.get(), POTTED_FOXGLOVE.get(), POTTED_BLUEBELLS.get(), POTTED_NIGHTSHADE.get(), POTTED_HOLLY_SAPLING.get(), POTTED_CHESTNUT_SAPLING.get(), POTTED_PINE_SAPLING.get(), POTTED_SNOWY_SPROUTS.get(), POTTED_SNOWDROP.get(), POTTED_GELISOL_SPROUTS.get(), POTTED_DRY_MOSSY_SPROUTS.get(), POTTED_MOSS_CAMPION.get(), POTTED_GINGER_FLOWER.get(), POTTED_MOSSY_SPROUTS.get());
