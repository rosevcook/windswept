...
public class WindsweptBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(WindsweptBlockTags.PINE_LOGS).add(PINE_LOG.get(), PINE_WOOD.get(), STRIPPED_PINE_LOG.get(), STRIPPED_PINE_WOOD.get(), WEATHERED_PINE_LOG.get(), WEATHERED_PINE_WOOD.get());
        ...
        this.tag(BlockTags.WALLS).add(BLUE_ICE_BRICK_WALL.get(), SNOW_BRICK_WALL.get(), PACKED_ICE_BRICK_WALL.get(), DRY_MOSSY_COBBLESTONE_WALL.get(), DRY_MOSSY_STONE_BRICK_WALL.get(), SHALE_WALL.get(), POLISHED_SHALE_BRICK_WALL.get());
        ...
        this.tag(BlockTags.SLABS).add(BLUE_ICE_BRICK_SLAB.get(), SNOW_BRICK_SLAB.get(), PACKED_ICE_BRICK_SLAB.get(), PACKED_ICE_SLAB.get(), BLUE_ICE_BRICK_SLAB.get(), SNOW_SLAB.get(), DRY_MOSSY_COBBLESTONE_SLAB.get(), DRY_MOSSY_STONE_BRICK_SLAB.get(), SHALE_SLAB.get(), POLISHED_SHALE_SLAB.get(), POLISHED_SHALE_BRICK_SLAB.get());
