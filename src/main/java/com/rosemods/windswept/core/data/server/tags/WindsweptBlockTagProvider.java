...
public class WindsweptBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(BlockTags.SLABS).add(BLUE_ICE_BRICK_SLAB.get(), SNOW_BRICK_SLAB.get(), PACKED_ICE_BRICK_SLAB.get(), PACKED_ICE_SLAB.get(), BLUE_ICE_BRICK_SLAB.get(), SNOW_SLAB.get(), DRY_MOSSY_COBBLESTONE_SLAB.get(), DRY_MOSSY_STONE_BRICK_SLAB.get());
        this.tag(BlockTags.STAIRS).add(BLUE_ICE_BRICK_STAIRS.get(), SNOW_BRICK_STAIRS.get(), PACKED_ICE_BRICK_STAIRS.get(), PACKED_ICE_STAIRS.get(), BLUE_ICE_STAIRS.get(), SNOW_STAIRS.get(), DRY_MOSSY_COBBLESTONE_STAIRS.get(), DRY_MOSSY_STONE_BRICK_STAIRS.get());
        this.tag(BlockTags.TALL_FLOWERS).add(RED_ROSE_BUSH.get(), PINK_ROSE_BUSH.get(), BLUE_ROSE_BUSH.get(), WHITE_ROSE_BUSH.get(), YELLOW_ROSE_BUSH.get(), WITHER_ROSE_BUSH.get(), LUPINE.get());
        this.tag(BlockTags.REPLACEABLE_PLANTS).add(RED_ROSE_BUSH.get(), PINK_ROSE_BUSH.get(), BLUE_ROSE_BUSH.get(), WHITE_ROSE_BUSH.get(), YELLOW_ROSE_BUSH.get(), WITHER_ROSE_BUSH.get(), SNOWY_SPROUTS.get(), GELISOL_SPROUTS.get(), DRY_MOSS_SPROUTS.get());
        this.tag(BlockTags.SMALL_FLOWERS).add(RED_ROSE.get(), PINK_ROSE.get(), BLUE_ROSE.get(), WHITE_ROSE.get(), YELLOW_ROSE.get(), FOXGLOVE.get(), BLUEBELLS.get(), NIGHTSHADE.get(), SNOWDROP.get(), MOSS_CAMPION.get());
        this.tag(BlockTags.FLOWER_POTS).add(POTTED_RED_ROSE.get(), POTTED_PINK_ROSE.get(), POTTED_BLUE_ROSE.get(), POTTED_WHITE_ROSE.get(), POTTED_YELLOW_ROSE.get(), POTTED_FOXGLOVE.get(), POTTED_BLUEBELLS.get(), POTTED_NIGHTSHADE.get(), POTTED_HOLLY_SAPLING.get(), POTTED_CHESTNUT_SAPLING.get(), POTTED_SNOWY_SPROUTS.get(), POTTED_SNOWDROP.get(), POTTED_GELISOL_SPROUTS.get(), POTTED_DRY_MOSS_SPROUTS.get(), POTTED_MOSS_CAMPION.get());
        this.tag(BlockTags.ICE).add(PACKED_ICE_STAIRS.get(), PACKED_ICE_SLAB.get(), PACKED_ICE_VERTICAL_SLAB.get(), BLUE_ICE_STAIRS.get(), BLUE_ICE_SLAB.get(), BLUE_ICE_VERTICAL_SLAB.get(), CUT_ICE.get(), ICE_SHEET.get(), CUT_ICE_SHEET.get(), ICICLES.get(), ICICLE_BLOCK.get(), CHISELED_ICICLE_BLOCK.get(), ICICLE_DOOR.get(), ICICLE_TRAPDOOR.get());
        ...
        this.tag(BlockTags.MINEABLE_WITH_AXE).add(HOLLY_BOOKSHELF.get(), HOLLY_VERTICAL_SLAB.get(), HOLLY_LADDER.get(), HOLLY_HEDGE.get(), HOLLY_CHEST.get(), HOLLY_TRAPPED_CHEST.get(), HOLLY_BERRY_BASKET.get(), HOLLY_POST.get(), STRIPPED_HOLLY_POST.get(), HOLLY_BEEHIVE.get(), HOLLY_BOARDS.get(), CHESTNUT_BOOKSHELF.get(), CHESTNUT_VERTICAL_SLAB.get(), CHESTNUT_LADDER.get(), CHESTNUT_HEDGE.get(), CHESTNUT_CHEST.get(), CHESTNUT_TRAPPED_CHEST.get(), CHESTNUT_CRATE.get(), ROASTED_CHESTNUT_CRATE.get(), CHESTNUT_POST.get(), STRIPPED_CHESTNUT_POST.get(), CHESTNUT_BEEHIVE.get(), CHESTNUT_BOARDS.get(), HOLLY_CABINET.get(), CHESTNUT_CABINET.get(), RED_MUSHROOM_BASKET.get(), BROWN_MUSHROOM_BASKET.get(), GLOW_SHROOM_BASKET.get(), WILD_BERRY_BASKET.get(), FROSTBITER_TROPHY.get());
        this.tag(BlockTags.MINEABLE_WITH_HOE).addTag(WindsweptBlockTags.HOLLY_LEAVES).addTag(WindsweptBlockTags.CHESTNUT_LEAVES).add(HOLLY_LEAF_CARPET.get(), CHESTNUT_LEAF_CARPET.get(), FROZEN_FLESH_BLOCK.get(), DRY_MOSS_CARPET.get(), DRY_MOSS_BLOCK.get());
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BLUE_ICE_BRICKS.get(), CHISELED_BLUE_ICE_BRICKS.get(), BLUE_ICE_BRICK_SLAB.get(), BLUE_ICE_BRICK_STAIRS.get(), BLUE_ICE_BRICK_VERTICAL_SLAB.get(), BLUE_ICE_BRICK_WALL.get(), PACKED_ICE_BRICKS.get(), CHISELED_PACKED_ICE_BRICKS.get(), PACKED_ICE_BRICK_SLAB.get(), PACKED_ICE_BRICK_STAIRS.get(), PACKED_ICE_BRICK_VERTICAL_SLAB.get(), PACKED_ICE_BRICK_WALL.get(), SNOW_BRICKS.get(), SNOW_BRICK_SLAB.get(), SNOW_BRICK_STAIRS.get(), SNOW_BRICK_VERTICAL_SLAB.get(), SNOW_BRICK_WALL.get(), CUT_ICE.get(), ICE_SHEET.get(), CUT_ICE_SHEET.get(), PACKED_ICE_STAIRS.get(), PACKED_ICE_SLAB.get(), PACKED_ICE_VERTICAL_SLAB.get(), BLUE_ICE_STAIRS.get(), BLUE_ICE_SLAB.get(), BLUE_ICE_VERTICAL_SLAB.get(), ICICLES.get(), ICICLE_BLOCK.get(), CHISELED_ICICLE_BLOCK.get(), DRY_MOSSY_COBBLESTONE.get(), DRY_MOSSY_COBBLESTONE_STAIRS.get(), DRY_MOSSY_COBBLESTONE_SLAB.get(), DRY_MOSSY_COBBLESTONE_WALL.get(), DRY_MOSSY_COBBLESTONE_VERTICAL_SLAB.get(), DRY_MOSSY_STONE_BRICKS.get(), DRY_MOSSY_STONE_BRICK_STAIRS.get(), DRY_MOSSY_STONE_BRICK_SLAB.get(), DRY_MOSSY_STONE_BRICK_WALL.get(), DRY_MOSSY_STONE_BRICK_VERTICAL_SLAB.get(), ICICLE_DOOR.get(), ICICLE_TRAPDOOR.get(), ICE_LANTERN.get());
        this.tag(BlockTags.MINEABLE_WITH_SHOVEL).add(SNOW_BRICKS.get(), SNOW_BRICK_SLAB.get(), SNOW_BRICK_STAIRS.get(), SNOW_BRICK_VERTICAL_SLAB.get(), SNOW_BRICK_WALL.get(), SNOW_STAIRS.get(), SNOW_SLAB.get(), SNOW_VERTICAL_SLAB.get(), GELISOL.get());
    }
