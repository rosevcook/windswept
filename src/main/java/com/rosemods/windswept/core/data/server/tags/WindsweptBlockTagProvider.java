...
public class WindsweptBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(BlueprintBlockTags.VERTICAL_SLABS).add(BLUE_ICE_BRICK_VERTICAL_SLAB.get(), HOLLY_VERTICAL_SLAB.get(), SNOW_BRICK_VERTICAL_SLAB.get(), CHESTNUT_VERTICAL_SLAB.get(), PACKED_ICE_BRICK_VERTICAL_SLAB.get(), PACKED_ICE_VERTICAL_SLAB.get(), BLUE_ICE_VERTICAL_SLAB.get(), SNOW_VERTICAL_SLAB.get());
        ...
        this.tag(BlockTags.SLABS).add(BLUE_ICE_BRICK_SLAB.get(), SNOW_BRICK_SLAB.get(), PACKED_ICE_BRICK_SLAB.get(), PACKED_ICE_SLAB.get(), BLUE_ICE_BRICK_SLAB.get(), SNOW_SLAB.get());
        this.tag(BlockTags.STAIRS).add(BLUE_ICE_BRICK_STAIRS.get(), SNOW_BRICK_STAIRS.get(), PACKED_ICE_BRICK_STAIRS.get(), PACKED_ICE_STAIRS.get(), BLUE_ICE_STAIRS.get(), SNOW_STAIRS.get());
        ...
        this.tag(BlockTags.REPLACEABLE_PLANTS).add(RED_ROSE_BUSH.get(), PINK_ROSE_BUSH.get(), BLUE_ROSE_BUSH.get(), WHITE_ROSE_BUSH.get(), YELLOW_ROSE_BUSH.get(), WITHER_ROSE_BUSH.get(), SNOWY_SPROUTS.get());
        this.tag(BlockTags.SMALL_FLOWERS).add(RED_ROSE.get(), PINK_ROSE.get(), BLUE_ROSE.get(), WHITE_ROSE.get(), YELLOW_ROSE.get(), FOXGLOVE.get(), BLUEBELLS.get(), NIGHTSHADE.get());
        this.tag(BlockTags.FLOWER_POTS).add(POTTED_RED_ROSE.get(), POTTED_PINK_ROSE.get(), POTTED_BLUE_ROSE.get(), POTTED_WHITE_ROSE.get(), POTTED_YELLOW_ROSE.get(), POTTED_FOXGLOVE.get(), POTTED_BLUEBELLS.get(), POTTED_NIGHTSHADE.get(), POTTED_HOLLY_SAPLING.get(), POTTED_CHESTNUT_SAPLING.get(), POTTED_SNOWY_SPROUTS.get());
        this.tag(BlockTags.ICE).add(PACKED_ICE_STAIRS.get(), PACKED_ICE_SLAB.get(), PACKED_ICE_VERTICAL_SLAB.get(), BLUE_ICE_STAIRS.get(), BLUE_ICE_SLAB.get(), BLUE_ICE_VERTICAL_SLAB.get(), CUT_ICE.get(), ICE_SHEET.get(), CUT_ICE_SHEET.get());
