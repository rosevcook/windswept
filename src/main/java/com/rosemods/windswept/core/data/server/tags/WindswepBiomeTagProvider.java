...
public class WindswepBiomeTagProvider extends BiomeTagsProvider {
    ...
    protected void addTags() {
        //windswept
        this.tag(WindsweptBiomeTags.HAS_BLUEBELLS).add(Biomes.DARK_FOREST).add(Biomes.BIRCH_FOREST).add(Biomes.OLD_GROWTH_BIRCH_FOREST).add(WindsweptBiomes.CHESTNUT_FOREST.get());
        this.tag(WindsweptBiomeTags.HAS_FOXGLOVES).addTag(BiomeTags.IS_TAIGA).add(WindsweptBiomes.CHESTNUT_FOREST.get());
        ...
        this.tag(WindsweptBiomeTags.HAS_COMMON_CHESTNUT_TREES).add(WindsweptBiomes.CHESTNUT_FOREST.get());

        //minecraft
        this.tag(BiomeTags.IS_TAIGA).add(Biomes.WINDSWEPT_FOREST).add(WindsweptBiomes.CHESTNUT_FOREST.get());
        this.tag(BiomeTags.HAS_RUINED_PORTAL_STANDARD).add(WindsweptBiomes.CHESTNUT_FOREST.get());
        this.tag(BiomeTags.HAS_STRONGHOLD).add(WindsweptBiomes.CHESTNUT_FOREST.get());
        this.tag(BiomeTags.HAS_MINESHAFT).add(WindsweptBiomes.CHESTNUT_FOREST.get());

        //forge
        this.tag(Tags.Biomes.IS_CONIFEROUS).add(WindsweptBiomes.CHESTNUT_FOREST.get());
    }
}
