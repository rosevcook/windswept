...
public class WindsweptRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(LAVENDER_FLOWER_CROWN.get()).define('#', LAVENDER.get()).define('F', FROZEN_BRANCH.get()).pattern("###").pattern("#F#").unlockedBy(getHasName(LAVENDER.get()), has(LAVENDER.get())).save(consumer, getSaveLocation(LAVENDER_FLOWER_CROWN.get()));
