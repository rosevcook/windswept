...
public class WindsweptRecipeProvider extends BlueprintRecipeProvider {
    ...
    public void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ELDER_ORNAMENT.get(), 8).define('#', Items.STICK).define('F', ELDER_FEATHER.get()).pattern("##").pattern("FF").unlockedBy(getHasName(ELDER_FEATHER.get()), has(ELDER_FEATHER.get())).save(consumer, getSaveLocation(ELDER_ORNAMENT.get()));
