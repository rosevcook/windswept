...
public class WindsweptRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        conditionalRecipe(ShapedRecipeBuilder.shaped(WindsweptBlocks.RED_MUSHROOM_CRATE.get()).define('#', Items.RED_MUSHROOM).pattern("###").pattern("###").pattern("###").unlockedBy("has_red_mushroom", has(Items.RED_MUSHROOM)), new OrCondition(new ModLoadedCondition("farmersdelight"), getQuarkCondition("apple_crate")), consumer, Windswept.REGISTRY_HELPER.prefix("red_mushroom_crate"));
        ...
        conditionalRecipe(ShapelessRecipeBuilder.shapeless(WindsweptItems.FROZEN_FLESH.get(), 9).requires(WindsweptBlocks.FROZEN_FLESH_BLOCK.get()).unlockedBy("has_brown_mushroom_crate", has(WindsweptBlocks.FROZEN_FLESH_BLOCK.get())), new ModLoadedCondition("caverns_and_chasms"), consumer, Windswept.REGISTRY_HELPER.prefix("frozen_flesh_block_revert"));
    }
