...
public class WindsweptRecipeProvider extends RecipeProvider {
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {		
		...
		ShapelessRecipeBuilder.shapeless(WindsweptBlocks.POLISHED_DEEPSLATE_BUTTON.get()).requires(Items.POLISHED_DEEPSLATE).unlockedBy("has_polished_deepslate", has(Items.POLISHED_DEEPSLATE)).save(consumer, Windswept.REGISTRY_HELPER.prefix("polished_deepslate_button"));
		ShapedRecipeBuilder.shaped(WindsweptBlocks.POLISHED_DEEPSLATE_PRESSURE_PLATE.get()).define('#', Items.POLISHED_DEEPSLATE).pattern("##").unlockedBy("has_polished_deepslate", has(Items.POLISHED_DEEPSLATE)).save(consumer, Windswept.REGISTRY_HELPER.prefix("polished_deepslate_pressure_plate"));
		...
		conditionalRecipe(ShapedRecipeBuilder.shaped(WindsweptBlocks.WILD_BERRY_SACK.get()).define('#', WindsweptItems.WILD_BERRIES.get()).pattern("###").pattern("###").pattern("###").unlockedBy("has_berries", has(WindsweptItems.WILD_BERRIES.get())), getQuarkCondition("berry_sack"), consumer, Windswept.REGISTRY_HELPER.prefix("wild_berry_sack"));
		conditionalRecipe(ShapelessRecipeBuilder.shapeless(WindsweptItems.WILD_BERRIES.get(), 9).requires(WindsweptBlocks.WILD_BERRY_SACK.get()).unlockedBy("has_wild_berry_sack", has(WindsweptBlocks.WILD_BERRY_SACK.get())), getQuarkCondition("berry_sack"), consumer, Windswept.REGISTRY_HELPER.prefix("wild_berry_sack_revert"));
		...
		conditionalRecipe(ShapedRecipeBuilder.shaped(WindsweptBlocks.HOLLY_BERRY_CRATE.get()).define('#', WindsweptItems.HOLLY_BERRIES.get()).pattern("###").pattern("###").pattern("###").unlockedBy("has_berries", has(WindsweptItems.HOLLY_BERRIES.get())), getQuarkCondition("berry_sack"), consumer, Windswept.REGISTRY_HELPER.prefix("holly_berry_crate"));
		conditionalRecipe(ShapelessRecipeBuilder.shapeless(WindsweptItems.HOLLY_BERRIES.get(), 9).requires(WindsweptBlocks.HOLLY_BERRY_CRATE.get()).unlockedBy("has_holly_berry_crate", has(WindsweptBlocks.HOLLY_BERRY_CRATE.get())), getQuarkCondition("berry_sack"), consumer, Windswept.REGISTRY_HELPER.prefix("holly_berry_crate_revert"));
		...
		conditionalRecipe(ShapedRecipeBuilder.shaped(WindsweptBlocks.RED_MUSHROOM_CRATE.get()).define('#', Items.RED_MUSHROOM).pattern("###").pattern("###").pattern("###").unlockedBy("has_red_mushroom", has(Items.RED_MUSHROOM)), getQuarkCondition("apple_crate"), consumer, Windswept.REGISTRY_HELPER.prefix("red_mushroom_crate"));
		conditionalRecipe(ShapelessRecipeBuilder.shapeless(Items.RED_MUSHROOM, 9).requires(WindsweptBlocks.RED_MUSHROOM_CRATE.get()).unlockedBy("has_red_mushroom_crate", has(WindsweptBlocks.RED_MUSHROOM_CRATE.get())), getQuarkCondition("apple_crate"), consumer, Windswept.REGISTRY_HELPER.prefix("red_mushroom_crate_revert"));
		conditionalRecipe(ShapedRecipeBuilder.shaped(WindsweptBlocks.BROWN_MUSHROOM_CRATE.get()).define('#', Items.BROWN_MUSHROOM).pattern("###").pattern("###").pattern("###").unlockedBy("has_brown_mushroom", has(Items.BROWN_MUSHROOM)), getQuarkCondition("apple_crate"), consumer, Windswept.REGISTRY_HELPER.prefix("brown_mushroom_crate"));
		conditionalRecipe(ShapelessRecipeBuilder.shapeless(Items.BROWN_MUSHROOM, 9).requires(WindsweptBlocks.BROWN_MUSHROOM_CRATE.get()).unlockedBy("has_brown_mushroom_crate", has(WindsweptBlocks.BROWN_MUSHROOM_CRATE.get())), getQuarkCondition("apple_crate"), consumer, Windswept.REGISTRY_HELPER.prefix("brown_mushroom_crate_revert"));
	}
