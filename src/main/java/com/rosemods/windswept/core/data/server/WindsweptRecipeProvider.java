...
public class WindsweptRecipeProvider extends BlueprintRecipeProvider {
    ...
    public void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, FEATHER_WING.get(), 8).define('#', PINECONE.get()).define('F', ELDER_FEATHER.get()).pattern("#FF").unlockedBy(getHasName(ELDER_FEATHER.get()), has(ELDER_FEATHER.get())).save(consumer, getSaveLocation(FEATHER_WING.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, FEATHER_ORNAMENT.get(), 8).define('#', PINECONE.get()).define('F', ELDER_FEATHER.get()).pattern("##").pattern("FF").unlockedBy(getHasName(ELDER_FEATHER.get()), has(ELDER_FEATHER.get())).save(consumer, getSaveLocation(FEATHER_ORNAMENT.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DREAM_CATCHER.get(), 1).define('#', PINECONE.get()).define('S', Items.STRING).define('F', ELDER_FEATHER.get()).pattern(" # ").pattern("FSF").pattern(" F ").unlockedBy(getHasName(ELDER_FEATHER.get()), has(ELDER_FEATHER.get())).save(consumer, getSaveLocation(DREAM_CATCHER.get()));
