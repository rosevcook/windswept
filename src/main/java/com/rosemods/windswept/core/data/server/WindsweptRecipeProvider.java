...
public class WindsweptRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        // blocks
        ShapelessRecipeBuilder.shapeless(GINGER_SOIL.get()).requires(Items.DIRT).requires(GINGER_ROOT.get()).unlockedBy(getHasName(GINGER_ROOT.get()), has(GINGER_ROOT.get())).save(consumer, getSaveLocation(GINGER_SOIL.get()));
        ...
        ShapedRecipeBuilder.shaped(GINGERBREAD_DOOR.get(), 3).define('#', GINGERBREAD_COOKIE.get()).pattern("##").pattern("##").pattern("##").unlockedBy(getHasName(GINGERBREAD_COOKIE.get()), has(GINGERBREAD_COOKIE.get())).save(consumer, getSaveLocation(GINGERBREAD_DOOR.get()));
        ShapedRecipeBuilder.shaped(GINGERBREAD_TRAPDOOR.get(), 2).define('#', GINGERBREAD_COOKIE.get()).pattern("###").pattern("###").unlockedBy(getHasName(GINGERBREAD_COOKIE.get()), has(GINGERBREAD_COOKIE.get())).save(consumer, getSaveLocation(GINGERBREAD_TRAPDOOR.get()));

        conditionalRecipe(ShapelessRecipeBuilder.shapeless(GLAZED_GINGERBREAD_BLOCK.get()).requires(GINGERBREAD_BLOCK.get()).requires(Items.SUGAR).unlockedBy(getHasName(GINGERBREAD_BLOCK.get()), has(GINGERBREAD_BLOCK.get())), new NotCondition(new ModLoadedCondition("create")), consumer, getSaveLocation("glazed_gingerbread_block_from_sugar"));
        conditionalRecipe(ShapelessRecipeBuilder.shapeless(GLAZED_GINGERBREAD_BRICKS.get()).requires(GINGERBREAD_BRICKS.get()).requires(Items.SUGAR).unlockedBy(getHasName(GINGERBREAD_BRICKS.get()), has(GINGERBREAD_BRICKS.get())), new NotCondition(new ModLoadedCondition("create")), consumer, getSaveLocation("glazed_gingerbread_bricks_from_sugar"));
