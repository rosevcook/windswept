...
public class WindsweptRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(TUNDRA_MOSSY_COBBLESTONE.get()).requires(Items.COBBLESTONE).requires(TUNDRA_MOSS_BLOCK.get()).unlockedBy(getHasName(TUNDRA_MOSS_BLOCK.get()), has(TUNDRA_MOSS_BLOCK.get())).save(consumer, getSaveLocation("tundra_mossy_cobblestone_from_tundra_moss"));
        ShapelessRecipeBuilder.shapeless(TUNDRA_MOSSY_STONE_BRICKS.get()).requires(Items.STONE_BRICKS).requires(TUNDRA_MOSS_BLOCK.get()).unlockedBy(getHasName(TUNDRA_MOSS_BLOCK.get()), has(TUNDRA_MOSS_BLOCK.get())).save(consumer, getSaveLocation("tundra_mossy_stone_bricks_from_tundra_moss"));
        ...
        brickSet(null, TUNDRA_MOSSY_STONE_BRICKS.get(), null, TUNDRA_MOSSY_STONE_BRICK_SLAB.get(), TUNDRA_MOSSY_STONE_BRICK_STAIRS.get(), TUNDRA_MOSSY_STONE_BRICK_WALL.get(), TUNDRA_MOSSY_STONE_BRICK_VERTICAL_SLAB.get(), consumer);
