...
public class WindsweptRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(CUPIDS_ARROW.get(), 4).define('#', LAVENDER.get()).define('F', OWL_FEATHER.get()).define('S', Items.STICK).pattern("#").pattern("S").pattern("F").unlockedBy(getHasName(LAVENDER.get()), has(LAVENDER.get())).save(consumer, getSaveLocation(CUPIDS_ARROW.get()));
        ...
        ShapedRecipeBuilder.shaped(FEATHER_CLOAK.get()).define('#', OWL_FEATHER.get()).define('L', Items.LEATHER).pattern("L L").pattern("#L#").pattern("###").unlockedBy(getHasName(OWL_FEATHER.get()), has(OWL_FEATHER.get())).save(consumer, getSaveLocation(FEATHER_CLOAK.get()));
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(LUNAROCK.get()), SMOOTH_LUNAROCK.get(), .1f, 200).unlockedBy(getHasName(LUNAROCK.get()), has(LUNAROCK.get())).save(consumer, getSaveLocation(SMOOTH_LUNAROCK.get()));
        ...
        stonecutting(LUNAROCK.get(), CUT_LUNAROCK_BRICKS.get(), 1, consumer);
        stonecutting(LUNAROCK.get(), CHISELED_CUT_LUNAROCK_BRICKS.get(), 1, consumer);
        stonecutting(LUNAROCK.get(), CUT_LUNAROCK_BRICK_SLAB.get(), 2, consumer);
        stonecutting(LUNAROCK.get(), CUT_LUNAROCK_BRICK_STAIRS.get(), 1, consumer);
        stonecutting(LUNAROCK.get(), CUT_LUNAROCK_BRICK_WALL.get(), 1, consumer);
        verticalSlabStonecutting(LUNAROCK.get(), CUT_LUNAROCK_BRICK_VERTICAL_SLAB.get(), consumer);
        stonecutting(LUNAROCK.get(), CUT_LUNAROCK.get(), 1, consumer);
        stonecutting(LUNAROCK.get(), CUT_LUNAROCK_SLAB.get(), 2, consumer);
        stonecutting(LUNAROCK.get(), CUT_LUNAROCK_STAIRS.get(), 1, consumer);
        stonecutting(LUNAROCK.get(), CUT_LUNAROCK_WALL.get(), 1, consumer);
        verticalSlabStonecutting(LUNAROCK.get(), CUT_LUNAROCK_VERTICAL_SLAB.get(), consumer);
        stonecutting(CUT_LUNAROCK.get(), CUT_LUNAROCK_BRICKS.get(), 1, consumer);
        stonecutting(CUT_LUNAROCK.get(), CHISELED_CUT_LUNAROCK_BRICKS.get(), 1, consumer);
        stonecutting(CUT_LUNAROCK.get(), CUT_LUNAROCK_BRICK_SLAB.get(), 2, consumer);
        stonecutting(CUT_LUNAROCK.get(), CUT_LUNAROCK_BRICK_STAIRS.get(), 1, consumer);
        stonecutting(CUT_LUNAROCK.get(), CUT_LUNAROCK_BRICK_WALL.get(), 1, consumer);
        verticalSlabStonecutting(CUT_LUNAROCK.get(), CUT_LUNAROCK_BRICK_VERTICAL_SLAB.get(), consumer);
        ...
        blockset(null, LUNAROCK.get(), null, LUNAROCK_SLAB.get(), LUNAROCK_STAIRS.get(), LUNAROCK_WALL.get(), LUNAROCK_VERTICAL_SLAB.get(), true, consumer);
        blockset(LUNAROCK.get(), CUT_LUNAROCK.get(), null, CUT_LUNAROCK_SLAB.get(), CUT_LUNAROCK_STAIRS.get(), CUT_LUNAROCK_WALL.get(), CUT_LUNAROCK_VERTICAL_SLAB.get(), true, consumer);
        blockset(CUT_LUNAROCK.get(), CUT_LUNAROCK_BRICKS.get(), CHISELED_CUT_LUNAROCK_BRICKS.get(), CUT_LUNAROCK_BRICK_SLAB.get(), CUT_LUNAROCK_BRICK_STAIRS.get(), CUT_LUNAROCK_BRICK_WALL.get(), CUT_LUNAROCK_BRICK_VERTICAL_SLAB.get(), true, consumer);
        blockset(null, SMOOTH_LUNAROCK.get(), null, SMOOTH_LUNAROCK_SLAB.get(), SMOOTH_LUNAROCK_STAIRS.get(), null, SMOOTH_LUNAROCK_VERTICAL_SLAB.get(), true, consumer);
