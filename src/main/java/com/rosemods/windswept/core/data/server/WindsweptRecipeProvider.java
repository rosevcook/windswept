...
public class WindsweptRecipeProvider extends BlueprintRecipeProvider {
    ...
    public void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        conditionalRecipe(ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, GINGER_TEA.get()).requires(Items.GLASS_BOTTLE).requires(GINGER_ROOT.get(), 2).requires(Items.SUGAR).unlockedBy(getHasName(GINGER_ROOT.get()), has(GINGER_ROOT.get())), new NotCondition(new ModLoadedCondition("windswept_delights")), consumer, getSaveLocation(GINGER_TEA.get()));
        conditionalRecipe(ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, LAVENDER_TEA.get()).requires(Items.GLASS_BOTTLE).requires(LAVENDER.get(), 4).unlockedBy(getHasName(LAVENDER.get()), has(LAVENDER.get())), new NotCondition(new ModLoadedCondition("windswept_delights")), consumer, getSaveLocation(LAVENDER_TEA.get()));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, SPICY_SNOW_CONE.get()).requires(PINECONE.get()).requires(GINGER_ROOT.get()).requires(ROASTED_CHESTNUTS.get()).requires(Items.SNOWBALL).requires(Items.SUGAR).unlockedBy(getHasName(GINGER_ROOT.get()), has(GINGER_ROOT.get())).save(consumer, getSaveLocation(SPICY_SNOW_CONE.get()));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, SWEET_SNOW_CONE.get()).requires(PINECONE.get()).requires(WILD_BERRIES.get()).requires(Items.SWEET_BERRIES).requires(Items.SNOWBALL).requires(Items.SUGAR).unlockedBy(getHasName(GINGER_ROOT.get()), has(GINGER_ROOT.get())).save(consumer, getSaveLocation(SWEET_SNOW_CONE.get()));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, MINTY_SNOW_CONE.get()).requires(PINECONE.get()).requires(LAVENDER.get()).requires(Items.COCOA_BEANS).requires(Items.SNOWBALL).requires(Items.SUGAR).unlockedBy(getHasName(GINGER_ROOT.get()), has(GINGER_ROOT.get())).save(consumer, getSaveLocation(MINTY_SNOW_CONE.get()));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, FEATHER_CLOAK.get()).define('#', ELDER_FEATHER.get()).define('L', Items.LEATHER).define('G', Items.GOLD_INGOT).pattern("L L").pattern("#G#").pattern("###").unlockedBy(getHasName(ELDER_FEATHER.get()), has(ELDER_FEATHER.get())).save(consumer, getSaveLocation(FEATHER_CLOAK.get()));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ICE_CHAIN.get(), 2).define('#', ICICLES.get()).pattern("#").pattern("#").pattern("#").unlockedBy(getHasName(ICICLES.get()), has(ICICLES.get())).save(consumer, getSaveLocation(ICE_CHAIN.get()));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ELDER_WING.get(), 8).define('#', Items.STICK).define('F', ELDER_FEATHER.get()).pattern("#FF").unlockedBy(getHasName(ELDER_FEATHER.get()), has(ELDER_FEATHER.get())).save(consumer, getSaveLocation(ELDER_WING.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ELDER_ORNAMENT.get(), 12).define('#', Items.STICK).define('F', ELDER_FEATHER.get()).pattern("##").pattern("FF").unlockedBy(getHasName(ELDER_FEATHER.get()), has(ELDER_FEATHER.get())).save(consumer, getSaveLocation(ELDER_ORNAMENT.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, DREAM_CATCHER.get(), 1).define('#', Items.STICK).define('S', Items.STRING).define('F', ELDER_FEATHER.get()).pattern(" # ").pattern("FSF").pattern(" F ").unlockedBy(getHasName(ELDER_FEATHER.get()), has(ELDER_FEATHER.get())).save(consumer, getSaveLocation(DREAM_CATCHER.get()));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, NIGHT_FAIRY_LIGHT.get()).requires(PINECONE.get()).requires(NIGHTSHADE.get()).unlockedBy(getHasName(PINECONE.get()), has(PINECONE.get())).save(consumer, getSaveLocation(NIGHT_FAIRY_LIGHT.get()));
        ...
        blockset(null, PINECONE_SHINGLES.get(), null, PINECONE_SHINGLE_SLAB.get(), PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        ...
        blockset(null, WHITE_PINECONE_SHINGLES.get(), null, WHITE_PINECONE_SHINGLE_SLAB.get(), WHITE_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, LIGHT_GRAY_PINECONE_SHINGLES.get(), null, LIGHT_GRAY_PINECONE_SHINGLE_SLAB.get(), LIGHT_GRAY_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, GRAY_PINECONE_SHINGLES.get(), null, GRAY_PINECONE_SHINGLE_SLAB.get(), GRAY_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, BLACK_PINECONE_SHINGLES.get(), null, BLACK_PINECONE_SHINGLE_SLAB.get(), BLACK_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, BROWN_PINECONE_SHINGLES.get(), null, BROWN_PINECONE_SHINGLE_SLAB.get(), BROWN_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, RED_PINECONE_SHINGLES.get(), null, RED_PINECONE_SHINGLE_SLAB.get(), RED_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, ORANGE_PINECONE_SHINGLES.get(), null, ORANGE_PINECONE_SHINGLE_SLAB.get(), ORANGE_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, YELLOW_PINECONE_SHINGLES.get(), null, YELLOW_PINECONE_SHINGLE_SLAB.get(), YELLOW_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, LIME_PINECONE_SHINGLES.get(), null, LIME_PINECONE_SHINGLE_SLAB.get(), LIME_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, GREEN_PINECONE_SHINGLES.get(), null, GREEN_PINECONE_SHINGLE_SLAB.get(), GREEN_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, CYAN_PINECONE_SHINGLES.get(), null, CYAN_PINECONE_SHINGLE_SLAB.get(), CYAN_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, LIGHT_BLUE_PINECONE_SHINGLES.get(), null, LIGHT_BLUE_PINECONE_SHINGLE_SLAB.get(), LIGHT_BLUE_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, BLUE_PINECONE_SHINGLES.get(), null, BLUE_PINECONE_SHINGLE_SLAB.get(), BLUE_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, PURPLE_PINECONE_SHINGLES.get(), null, PURPLE_PINECONE_SHINGLE_SLAB.get(), PURPLE_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, MAGENTA_PINECONE_SHINGLES.get(), null, MAGENTA_PINECONE_SHINGLE_SLAB.get(), MAGENTA_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);
        blockset(null, PINK_PINECONE_SHINGLES.get(), null, PINK_PINECONE_SHINGLE_SLAB.get(), PINK_PINECONE_SHINGLE_STAIRS.get(), null, false, consumer);

        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, WHITE_PINECONE_SHINGLES.get(), 8).define('D', Items.WHITE_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(WHITE_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, LIGHT_GRAY_PINECONE_SHINGLES.get(), 8).define('D', Items.LIGHT_GRAY_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(LIGHT_GRAY_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, GRAY_PINECONE_SHINGLES.get(), 8).define('D', Items.GRAY_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(GRAY_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, BLACK_PINECONE_SHINGLES.get(), 8).define('D', Items.BLACK_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(BLACK_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, BROWN_PINECONE_SHINGLES.get(), 8).define('D', Items.BROWN_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(BROWN_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, RED_PINECONE_SHINGLES.get(), 8).define('D', Items.RED_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(RED_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ORANGE_PINECONE_SHINGLES.get(), 8).define('D', Items.ORANGE_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(ORANGE_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, YELLOW_PINECONE_SHINGLES.get(), 8).define('D', Items.YELLOW_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(YELLOW_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, LIME_PINECONE_SHINGLES.get(), 8).define('D', Items.LIME_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(LIME_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, GREEN_PINECONE_SHINGLES.get(), 8).define('D', Items.GREEN_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(GREEN_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, CYAN_PINECONE_SHINGLES.get(), 8).define('D', Items.CYAN_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(CYAN_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, BLUE_PINECONE_SHINGLES.get(), 8).define('D', Items.BLUE_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(BLUE_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, PURPLE_PINECONE_SHINGLES.get(), 8).define('D', Items.PURPLE_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(PURPLE_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, MAGENTA_PINECONE_SHINGLES.get(), 8).define('D', Items.MAGENTA_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(MAGENTA_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, PINK_PINECONE_SHINGLES.get(), 8).define('D', Items.PINK_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(consumer, getSaveLocation(PINK_PINECONE_SHINGLES.get()));

        // wood sets
        woodSet(WindsweptItemTags.HOLLY_LOGS, HOLLY_PLANKS.get(), HOLLY_SLAB.get(), HOLLY_STAIRS.get(), HOLLY_LOG.get(), HOLLY_WOOD.get(), STRIPPED_HOLLY_LOG.get(), STRIPPED_HOLLY_WOOD.get(), HOLLY_BOAT.getFirst().get(), HOLLY_BOAT.getSecond().get(), HOLLY_BUTTON.get(), HOLLY_DOOR.get(), HOLLY_TRAPDOOR.get(), HOLLY_FENCE.get(), HOLLY_FENCE_GATE.get(), HOLLY_PRESSURE_PLATE.get(), HOLLY_SIGNS.getFirst().get(), HOLLY_BOARDS.get(), HOLLY_BEEHIVE.get(), HOLLY_LADDER.get(), HOLLY_BOOKSHELF.get(), HOLLY_CHEST.get(), TRAPPED_HOLLY_CHEST.get(), LARGE_HOLLY_BOAT.get(), HOLLY_FURNACE_BOAT.get(), HOLLY_HANGING_SIGNS.getFirst().get(), CHISELED_HOLLY_BOOKSHELF.get(), consumer);
        woodSet(WindsweptItemTags.CHESTNUT_LOGS, CHESTNUT_PLANKS.get(), CHESTNUT_SLAB.get(), CHESTNUT_STAIRS.get(), CHESTNUT_LOG.get(), CHESTNUT_WOOD.get(), STRIPPED_CHESTNUT_LOG.get(), STRIPPED_CHESTNUT_WOOD.get(), CHESTNUT_BOAT.getFirst().get(), CHESTNUT_BOAT.getSecond().get(), CHESTNUT_BUTTON.get(), CHESTNUT_DOOR.get(), CHESTNUT_TRAPDOOR.get(), CHESTNUT_FENCE.get(), CHESTNUT_FENCE_GATE.get(), CHESTNUT_PRESSURE_PLATE.get(), CHESTNUT_SIGNS.getFirst().get(), CHESTNUT_BOARDS.get(), CHESTNUT_BEEHIVE.get(), CHESTNUT_LADDER.get(), CHESTNUT_BOOKSHELF.get(), CHESTNUT_CHEST.get(), TRAPPED_CHESTNUT_CHEST.get(), LARGE_CHESTNUT_BOAT.get(), CHESTNUT_FURNACE_BOAT.get(), CHESTNUT_HANGING_SIGNS.getFirst().get(), CHISELED_CHESTNUT_BOOKSHELF.get(), consumer);
        woodSet(WindsweptItemTags.PINE_LOGS, PINE_PLANKS.get(), PINE_SLAB.get(), PINE_STAIRS.get(), PINE_LOG.get(), PINE_WOOD.get(), STRIPPED_PINE_LOG.get(), STRIPPED_PINE_WOOD.get(), PINE_BOAT.getFirst().get(), PINE_BOAT.getSecond().get(), PINE_BUTTON.get(), PINE_DOOR.get(), PINE_TRAPDOOR.get(), PINE_FENCE.get(), PINE_FENCE_GATE.get(), PINE_PRESSURE_PLATE.get(), PINE_SIGNS.getFirst().get(), PINE_BOARDS.get(), PINE_BEEHIVE.get(), PINE_LADDER.get(), PINE_BOOKSHELF.get(), PINE_CHEST.get(), TRAPPED_PINE_CHEST.get(), LARGE_PINE_BOAT.get(), PINE_FURNACE_BOAT.get(), PINE_HANGING_SIGNS.getFirst().get(), CHISELED_PINE_BOOKSHELF.get(), consumer);
    ...
    private static void woodSet(TagKey<Item> logs, Block planks, Block slab, Block stairs, Block log, Block wood, Block strippedLog, Block strippedWood, ItemLike boat, ItemLike chestBoat, Block button, Block door, Block trapdoor, Block fence, Block fenceGate, Block pressurePlate, Block sign, Block boards, Block beehive, Block ladder, Block bookshelf, Block chest, Block trappedChest, Item largeBoat, Item furnaceBoat, Block hangingSign, Block chiseledBookshelf, Consumer<FinishedRecipe> consumer) {
        ...
        conditionalRecipe(ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, chiseledBookshelf).group("wooden_chiseled_bookshelves").define('#', planks).define('S', slab).pattern("###").pattern("SSS").pattern("###").unlockedBy(getHasName(planks), has(planks)), woodworks, consumer, getSaveLocation(chiseledBookshelf));
    }
