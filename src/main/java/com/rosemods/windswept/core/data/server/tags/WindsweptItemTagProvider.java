...
public class WindsweptItemTagProvider extends ItemTagsProvider {
    ...
    protected void addTags() {
        ...
        //vanilla
        this.tag(ItemTags.BOATS).add(WindsweptItems.HOLLY_BOATS.getFirst().get(), WindsweptItems.CHESTNUT_BOATS.getFirst().get());
        this.tag(ItemTags.CHEST_BOATS).add(WindsweptItems.HOLLY_BOATS.getSecond().get(), WindsweptItems.CHESTNUT_BOATS.getSecond().get());
