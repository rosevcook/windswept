...
public class WindsweptModdedBiomeSliceProvider extends ModdedBiomeSliceProvider {
    ...
    private static final class WindsweptBiomeBuilder {
        ...
        private final ResourceKey<Biome>[][] MIDDLE_BIOMES = new ResourceKey[][]{{WindsweptBiomes.TUNDRA.getKey(), WindsweptBiomes.TUNDRA.getKey(), WindsweptBiomes.TUNDRA.getKey(), WindsweptBiomes.SNOWY_CHESTNUT_FOREST.getKey(), WindsweptBiomes.CHESTNUT_FOREST.getKey()}, {WindsweptBiomes.LAVENDER_FIELD.getKey(), WindsweptBiomes.LAVENDER_FIELD.getKey(), WindsweptBiomes.LAVENDER_FOREST.getKey(), WindsweptBiomes.CHESTNUT_FOREST.getKey(), WindsweptBiomes.PINE_BARRENS.getKey()}, {VANILLA, WindsweptBiomes.LAVENDER_FIELD.getKey(), WindsweptBiomes.LAVENDER_FOREST.getKey(), VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}};
        ...
        private final ResourceKey<Biome>[][] PLATEAU_BIOMES = new ResourceKey[][]{{WindsweptBiomes.TUNDRA.getKey(), WindsweptBiomes.TUNDRA.getKey(), WindsweptBiomes.TUNDRA.getKey(), WindsweptBiomes.SNOWY_CHESTNUT_FOREST.getKey(), WindsweptBiomes.SNOWY_CHESTNUT_FOREST.getKey()}, {VANILLA, VANILLA, VANILLA, WindsweptBiomes.CHESTNUT_FOREST.getKey(), WindsweptBiomes.PINE_BARRENS.getKey()}, {WindsweptBiomes.LAVENDER_FIELD.getKey(), WindsweptBiomes.LAVENDER_FIELD.getKey(), WindsweptBiomes.LAVENDER_FIELD.getKey(), VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}};
