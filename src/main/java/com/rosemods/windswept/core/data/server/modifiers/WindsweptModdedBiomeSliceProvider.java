...
public class WindsweptModdedBiomeSliceProvider extends ModdedBiomeSliceProvider {
    ...
    private static final class ChestnutBiomeBuilder {
        ...
        private final ResourceKey<Biome>[][] MIDDLE_BIOMES_VARIANT = new ResourceKey[][]{{VANILLA, null, VANILLA, null, null}, {WindsweptBiomes.BLUEBELL_WOODS.getKey(), null, null, null, VANILLA}, {VANILLA, WindsweptBiomes.CHESTNUT_FOREST.getKey(), null, VANILLA, null}, {null, null, VANILLA, VANILLA, VANILLA}, {null, null, null, null, null}};
