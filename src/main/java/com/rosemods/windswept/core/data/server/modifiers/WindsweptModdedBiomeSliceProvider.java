...
public class WindsweptModdedBiomeSliceProvider extends ModdedBiomeSliceProvider {
    ...
    private static final class WindsweptBiomeBuilder {
        ...
        private final ResourceKey<Biome>[][] MIDDLE_BIOMES = new ResourceKey[][]{{WindsweptBiomes.TUNDRA.getKey(), WindsweptBiomes.TUNDRA.getKey(), WindsweptBiomes.TUNDRA.getKey(), WindsweptBiomes.SNOWY_CHESTNUT_FOREST.getKey(), WindsweptBiomes.CHESTNUT_FOREST.getKey()}, {VANILLA, VANILLA, VANILLA, WindsweptBiomes.CHESTNUT_FOREST.getKey(), WindsweptBiomes.PINE_BARRENS.getKey()}, {VANILLA, VANILLA, VANILLA, WindsweptBiomes.LAVENDER_FOREST.getKey(), VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}};
        private final ResourceKey<Biome>[][] MIDDLE_BIOMES_VARIANT = new ResourceKey[][]{{VANILLA, null, WindsweptBiomes.SNOWY_CHESTNUT_FOREST.getKey(), null, null}, {null, null, null, null, WindsweptBiomes.PINE_BARRENS.getKey()}, {VANILLA, null, null, WindsweptBiomes.LAVENDER_FOREST.getKey(), null}, {null, null, VANILLA, VANILLA, VANILLA}, {null, null, null, null, null}};
        private final ResourceKey<Biome>[][] PLATEAU_BIOMES = new ResourceKey[][]{{WindsweptBiomes.TUNDRA.getKey(), WindsweptBiomes.TUNDRA.getKey(), WindsweptBiomes.TUNDRA.getKey(), WindsweptBiomes.SNOWY_CHESTNUT_FOREST.getKey(), WindsweptBiomes.SNOWY_CHESTNUT_FOREST.getKey()}, {WindsweptBiomes.LAVENDER_FIELD.getKey(), WindsweptBiomes.LAVENDER_FIELD.getKey(), VANILLA, WindsweptBiomes.CHESTNUT_FOREST.getKey(), WindsweptBiomes.PINE_BARRENS.getKey()}, {WindsweptBiomes.LAVENDER_FIELD.getKey(), WindsweptBiomes.LAVENDER_FIELD.getKey(), WindsweptBiomes.LAVENDER_FIELD.getKey(), WindsweptBiomes.LAVENDER_FIELD.getKey(), VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}};
        private final ResourceKey<Biome>[][] PLATEAU_BIOMES_VARIANT = new ResourceKey[][]{{VANILLA, null, null, null, null}, {null, null, WindsweptBiomes.LAVENDER_FIELD.getKey(), WindsweptBiomes.LAVENDER_FIELD.getKey(), VANILLA}, {null, null, VANILLA, WindsweptBiomes.LAVENDER_FOREST.getKey(), null}, {null, null, null, null, null}, {VANILLA, VANILLA, null, null, null}};
