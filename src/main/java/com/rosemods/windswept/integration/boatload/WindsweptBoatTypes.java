...
public final class WindsweptBoatTypes {
    public static final BoatloadBoatType HOLLY = BoatloadBoatType.register(BoatloadBoatType.create(Windswept.REGISTRY_HELPER.prefix("holly"), () -> WindsweptBlocks.HOLLY_PLANKS.get().asItem(), () -> WindsweptItems.HOLLY_BOATS.getFirst().get(), () -> WindsweptItems.HOLLY_BOATS.getSecond().get(), () -> WindsweptItems.HOLLY_FURNACE_BOAT.get(), () -> WindsweptItems.LARGE_HOLLY_BOAT.get()));
    public static final BoatloadBoatType CHESTNUT = BoatloadBoatType.register(BoatloadBoatType.create(Windswept.REGISTRY_HELPER.prefix("chestnut"), () -> WindsweptBlocks.CHESTNUT_PLANKS.get().asItem(), () -> WindsweptItems.CHESTNUT_BOATS.getFirst().get(), () -> WindsweptItems.CHESTNUT_BOATS.getSecond().get(), () -> WindsweptItems.CHESTNUT_FURNACE_BOAT.get(), () -> WindsweptItems.LARGE_CHESTNUT_BOAT.get()));
    public static final BoatloadBoatType PINE = BoatloadBoatType.register(BoatloadBoatType.create(Windswept.REGISTRY_HELPER.prefix("pine"), () -> WindsweptBlocks.PINE_PLANKS.get().asItem(), () -> WindsweptItems.PINE_BOATS.getFirst().get(), () -> WindsweptItems.PINE_BOATS.getSecond().get(), () -> WindsweptItems.PINE_FURNACE_BOAT.get(), () -> WindsweptItems.LARGE_PINE_BOAT.get()));
